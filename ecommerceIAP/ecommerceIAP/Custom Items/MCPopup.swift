...
class MCPopup: UIView {
    ...
    fileprivate func setupViews() {
        ...
        let arrayOfViews: [UIView] = [titleLabel,
                            oneImageView,
                            oneCreditLabel,
                            priceLabel,
                            buyButton]
        ...
        stack.topAnchor.constraint(equalTo: container.topAnchor, constant: 25).isActive = true
        stack.bottomAnchor.constraint(equalTo: container.bottomAnchor, constant: -25).isActive = true
        
        oneImageView.heightAnchor.constraint(equalToConstant: 80).isActive = true
